...
public class EntityInit
{
    public static void registerEntities()
    {
        ...
        registerEntity("butterfly", EntityButterflyRedAdmiral.class, ModConfiguration.ENTITY_BUTTERFLY_ID, 50, 12204575, 7092767);
        registerEntity("fly", EntityHouseFly.class, ModConfiguration.ENTITY_FLY_ID, 50, 5059661, 16711680);
